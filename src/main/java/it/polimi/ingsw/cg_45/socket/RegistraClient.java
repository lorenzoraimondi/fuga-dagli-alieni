...
public class RegistraClient {
	 ...
	 */
	public RegistraClient(SocketServer server, Communicator client, PacchettoAzione pacchetto){
		this.server=server;
		this.client=client;
	 ...
	 * and returning him the confirm, containing his race and id as mentioned in {@link SocketClient}
